...
export const QUERY_API_GAMES:string = 'fields name, summary, screenshots.url, platforms.name, release_dates.human, rating;sort rating desc;where rating != null;limit 5;offset {{page}};'